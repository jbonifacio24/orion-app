    ...
    return Scaffold(
        ...
        child: SafeArea(
          ...
          IconButton(
            ...
            icon: const Icon(Icons.chat_bubble_outline),
              ...
              _MenuItem(icon: Icons.forum_outlined, label: AppLocalizations.communityTitle(Localizations.localeOf(context)), routeName: 'community'),
              _MenuItem(icon: Icons.article_outlined, label: AppLocalizations.newsTitle(Localizations.localeOf(context)), routeName: RouteNames.news),
      ...
      body: Center(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const SizedBox(height: 12),
          FilledButton.icon(onPressed: () => context.pushNamed('community'), icon: const Icon(Icons.forum_outlined), label: Text(AppLocalizations.communityTitle(Localizations.localeOf(context)))),
          const SizedBox(height: 12),
          FilledButton.icon(onPressed: () => context.pushNamed(RouteNames.news), icon: const Icon(Icons.article_outlined), label: Text(AppLocalizations.newsTitle(Localizations.localeOf(context)))),
          const SizedBox(height: 12),
